...
const contact = () => {
	...
	on('submit', form, event => {
		...
		sendForm('yahoo', 'template_qSCs8dnD', form, 'user_GZpnqMDRG2NWjHzJGoNG4')
			.then(() => showAlert('Sucesso!', 'Mensagem enviada,<br>logo retornarei o contato.'))
			.catch(() => showAlert('Erro!', 'Erro ao enviar mensagem,<br>entre em contato utilizando outro canal.'))
			.finally(() => {
